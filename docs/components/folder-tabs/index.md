...
![The control in light theme: a white active tab merged into a white panel, grey inactive tabs on a near-black rail](/screenshots/folder-tabs/tabs-light.png)

</div>

<div class="shot only-dark">

![The control in dark theme: a mid-grey active tab merged into a matching panel, darker inactive tabs on a near-black rail](/screenshots/folder-tabs/tabs-dark.png)
...
There is a whole page on this: [The Mechanic](/components/folder-tabs/the-mechanic).
...
Everything lives under `components/folder-tabs/` in the repository:
...
- [Installation](/components/folder-tabs/installation) — copy the files in. Three paths: CSS only,
  vanilla, React.
- [Quick Start](/components/folder-tabs/quick-start) — the shortest working example of each.
- [The Mechanic](/components/folder-tabs/the-mechanic) — the long version of the idea above.
- [Theming](/components/folder-tabs/theming) — the eight variables, the dark-mode trap, and the
  contrast numbers.
- [Accessibility](/components/folder-tabs/accessibility) — the ARIA tab pattern as implemented.
