...
[![Docs](https://img.shields.io/badge/docs-github%20pages-informational.svg)](https://spcaeo.github.io/ui/components/folder-tabs/)
...
![Folder tabs in light mode](../../docs/public/screenshots/folder-tabs/tabs-light.png)

```bash
git clone https://github.com/spcaeo/ui.git
open ui/components/folder-tabs/demo.html
```
...
is this stylesheet with its eight colour variables set to the original's colourway,
which is the whole retheming surface.

![The VB colourway, rebuilt with this control](../../docs/public/screenshots/folder-tabs/heritage-vb-colourway.png)
...
![The control in greyscale, still legible](../../docs/public/screenshots/folder-tabs/greyscale-proof.png)
...
| Light                                                             | Dark                                                             |
| ----------------------------------------------------------------- | ---------------------------------------------------------------- |
| ![](../../docs/public/screenshots/folder-tabs/nested-light.png)   | ![](../../docs/public/screenshots/folder-tabs/nested-dark.png)   |
| ![](../../docs/public/screenshots/folder-tabs/overflow-light.png) | ![](../../docs/public/screenshots/folder-tabs/overflow-dark.png) |
...
Eight variables, and nothing else:

```css
:root {
  /* the three fills the mechanic is built from */
  ...
  /* their text */
  --tab-rail-ink: oklch(0.96 0 0);
  --tab-panel-ink: oklch(0.145 0 0);

  /* the stroke that carries every boundary — see Contrast */
  --tab-edge: oklch(0.2 0.02 260);

  /* focus. Two, because one ring colour cannot read on both grounds */
  --tab-ring: oklch(0.98 0 0); /* on an inactive tab */
  --tab-ring-on-panel: oklch(0.3 0 0); /* on the active tab or panel */
}
```
...
components/folder-tabs/
  ...
  demo.html              nesting, overflow, disabled, flush, dark
  heritage.html          the original VB colourway, same stylesheet
  test.mjs               behavioural tests, run by tools/smoke-test.mjs
...
repo root/
  ...
  tools/smoke-test.mjs   the browser test runner
  docs/                  the documentation site (all components)
```

## Scripts

```bash
npm run contrast folder-tabs   # re-measure every ratio from folder-tabs.css
npm test folder-tabs           # 20 behavioural tests in headless Chromium
...
Full docs at **[spcaeo.github.io/ui/components/folder-tabs](https://spcaeo.github.io/ui/components/folder-tabs/)** —
the mechanic, theming, accessibility, nesting, overflow, and the complete CSS,
React and vanilla APIs.

## Contributing

See [CONTRIBUTING.md](CONTRIBUTING.md). One hard rule: the fills are a
